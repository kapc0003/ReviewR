...
Description: ReviewR Assignment - iOS Cordova App
...
let currentReview = 0;
//localStorage.removeItem("reviewr-kapc0003");
...
function SaveToLS(){
    localStorage.setItem("reviewr-kapc0003", JSON.stringify(reviewList));
}

function RetrieveFromLS(){
    if(!localStorage.getItem("reviewr-kapc0003")){
        console.log("No data found");
    }
    else{
        reviewList = JSON.parse(localStorage.getItem("reviewr-kapc0003"));
